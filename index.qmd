...
Dataset obtenido de kaggle que puedes descargar [acá](https://1drv.ms/u/c/3ba457a6b989f5e0/EWI1LiXfz6hPi6dtiW9ZEe8By2x1nizOr4aWF5s7TlUJNQ?e=SaUHmw)
...
Construiremos a mano una matriz DFM. Para ello, considera que cada verso es un documento
...
Desde la próxima clase comenzaremos a usar un [dataset](https://1drv.ms/f/c/3ba457a6b989f5e0/EuaXjqBokM9Hgxj3jGVz1yMBVxSBytydRP548AxwN2sl7g?e=SZAEDh) de noticias de medios chilenos de prensa

![](imagenes/socialtec.png){fig-align="center"}


## tarea

1. Utiliza la columna **contenido_limpio** y explora algunos conceptos que te interesen en el dataset con la función kwic

2. Crea una matriz tfidf, implementando los pasos vistos durante esta clase.

3. Busca una noticia que te parezca interesante e intenta encontrar las 5 más parecidas, utilizando las herramientas revisadas en la clase

## IMPORTANTE

-   El formato del archivo es parquet. Debes usar el paquete arrow

```{r, eval = FALSE}
library(arrow)

data <- read_parquet("data/noticias_respaldo_2025-05-31.parquet")

```

-   Debido al tamaño, recomiendo utilizar una muestra del 1% antes de construir la matriz
